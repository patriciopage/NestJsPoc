...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_INCIDENT),
          REQUEST(ACTION_TYPES.UPDATE_INCIDENT),
          REQUEST(ACTION_TYPES.PARTIAL_UPDATE_INCIDENT),
          REQUEST(ACTION_TYPES.DELETE_INCIDENT),
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.PARTIAL_UPDATE_INCIDENT),
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.PARTIAL_UPDATE_INCIDENT actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.PARTIAL_UPDATE_INCIDENT),
        },
        {
          type: SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_INCIDENT),
          payload: resolvedObject,
        },
      ];
