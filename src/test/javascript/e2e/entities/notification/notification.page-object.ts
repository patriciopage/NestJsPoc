...
export class NotificationDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('myApp.notification.delete.question'));
...
export default class NotificationComponentsPage {
  ...
  async deleteNotification() {
    ...
    expect(await notificationDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/myApp.notification.delete.question/);
